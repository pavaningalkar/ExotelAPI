...
public class ConnectCustomerToAgent {
	...
	*The options for CallType are "trans" for transactional call and "promo" for promotional call
        */
        nameValuePairs.add(new BasicNameValuePair("From", "<First-phone-number-to-call (Your agent's number)>"));
        nameValuePairs.add(new BasicNameValuePair("To", "<Second-phone-number-to-call (Your customer's number)>"));
